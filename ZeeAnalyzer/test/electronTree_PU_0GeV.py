...
readFiles.extend([
'file:/eos/cms/store/user/taroni/DYToEE_M-50_NNPDF31_TuneCP5_13TeV-powheg-pythia8/DYEE_pierreTag/newtest_DIGI_L1_DIGI2RAW_RAW2DIGI_RECO_PU_sum8gt0.root'
#'file:test_DIGI_L1_DIGI2RAW_RAW2DIGI_RECO_PU_sum8gt0.root'
])

process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(-1) )
inputFiles = readFiles
outputFile = "electronTree_PierreTag_MCPU_0GeV_reweight.root"
