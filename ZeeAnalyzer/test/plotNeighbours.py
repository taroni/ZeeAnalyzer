...
xtalEnOverTotEn=file0.Get("xtalEnOverTotEn")
xtalEn_vs_firstNeigh=file0.Get("xtalEn_vs_firstNeigh")
...
eleEn=file0.Get("eleEn")
eleRawEn=file0.Get("eleRawEn")
eleEn_leftRightOverSum8LT0p3=file0.Get("eleEn_leftRightOverSum8LT0p3")
eleRawEn_leftRightOverSum8LT0p3=file0.Get("eleRawEn_leftRightOverSum8LT0p3")
eleEn_leftRightOverSum8LT0p5=file0.Get("eleEn_leftRightOverSum8LT0p5")
eleRawEn_leftRightOverSum8LT0p5=file0.Get("eleRawEn_leftRightOverSum8LT0p5")
...
canvas.Clear()
legend=ROOT.TLegend(0.5, 0.85, 0.7 , 0.6)
...
pad1.cd()
eleEn.Draw("HIST")
eleEn.SetLineColor(1)
eleEn_leftRightOverSum8LT0p3.Draw("HISTSAME")
eleEn_leftRightOverSum8LT0p3.SetLineColor(2)
eleEn_leftRightOverSum8LT0p5.Draw("HISTSAME")
eleEn_leftRightOverSum8LT0p5.SetLineColor(4)
legend.AddEntry(eleEn,"all electron", "l")
legend.AddEntry(eleEn_leftRightOverSum8LT0p3,"ratio<0.3", "l")
legend.AddEntry(eleEn_leftRightOverSum8LT0p5,"ratio<0.5", "l")
legend.Draw()
pad2.cd()
eleEn.Sumw2()
eleEn_leftRightOverSum8LT0p3.Sumw2()
eleEn_leftRightOverSum8LT0p5.Sumw2()
ratio1=eleEn_leftRightOverSum8LT0p3.Clone()
ratio1.Divide(eleEn)
ratio2=eleEn_leftRightOverSum8LT0p5.Clone()
ratio2.Divide(eleEn)
ratio1.Draw("HIST")
ratio2.Draw("HISTSAME")
ratio1.GetYaxis().SetRangeUser(0,1)
canvas.SaveAs("plots/eleEn_leftRightOverSum8.png")
canvas.SaveAs("plots/eleEn_leftRightOverSum8.pdf")
...
pad1.cd()
eleRawEn.Draw("HIST")
eleRawEn.SetLineColor(1)
eleRawEn_leftRightOverSum8LT0p3.Draw("HISTSAME")
eleRawEn_leftRightOverSum8LT0p3.SetLineColor(2)
eleRawEn_leftRightOverSum8LT0p5.Draw("HISTSAME")
eleRawEn_leftRightOverSum8LT0p5.SetLineColor(4)
legend.Draw()
pad2.cd()
eleRawEn.Sumw2()
eleRawEn_leftRightOverSum8LT0p3.Sumw2()
eleRawEn_leftRightOverSum8LT0p5.Sumw2()
ratio1=eleRawEn_leftRightOverSum8LT0p3.Clone()
ratio1.Divide(eleRawEn)
ratio2=eleRawEn_leftRightOverSum8LT0p5.Clone()
ratio2.Divide(eleRawEn)
ratio1.Draw("HIST")
ratio2.Draw("HISTSAME")
ratio1.GetYaxis().SetRangeUser(0,1)
canvas.SaveAs("plots/eleRawEn_leftRightOverSum8.png")
canvas.SaveAs("plots/eleRawEn_leftRightOverSum8.pdf")
...
canvas.Clear()
xtalEnOverTotEn.Scale(1./xtalEnOverTotEn.Integral())
xtalEnOverTotEn.Draw()
xtalEnOverTotEn.GetXaxis().SetTitle("xtal En / tot En")
canvas.SaveAs("plots/xtalEnOverTotEn.pdf")
canvas.SaveAs("plots/xtalEnOverTotEn.png")

canvas.Clear()
xtalEn_vs_firstNeigh.Scale(1./xtalEn_vs_firstNeigh.Integral())
xtalEn_vs_firstNeigh.Draw("COLZ")
xtalEn_vs_firstNeigh.GetXaxis().SetTitle("most energetic neighbour Energy [GeV]")
xtalEn_vs_firstNeigh.GetYaxis().SetTitle("recovered Energy [GeV]")

canvas.SaveAs("plots/xtalEn_vs_firstNeigh.pdf")
canvas.SaveAs("plots/xtalEn_vs_firstNeigh.png")
