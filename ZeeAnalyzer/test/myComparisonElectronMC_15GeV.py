...
tree0 =uproot.open("electronTree_sum8gt0.root")['ntupler']['selected']
tree15=uproot.open("electronTree_sum8gt15.root")['ntupler']['selected']
...
indata15=indata15[(indata15.e1IsRecovered==True) | (indata15.e2IsRecovered==True)]
