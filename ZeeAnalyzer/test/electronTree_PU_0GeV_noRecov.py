...
readFiles.extend([
'file:/eos/cms/store/user/taroni/DYToEE_M-50_NNPDF31_TuneCP5_13TeV-powheg-pythia8/DYEE_pierreTag/DYEE_noChanges_pierre_PU_all.root'
])

process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(-1) )
inputFiles = readFiles
outputFile = "electronTree_PierreTag_MCPU_0GeV_noRecov_reweight.root"
